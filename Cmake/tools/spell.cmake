...
option(PROJECT_ENABLE_SPELL
       "Enable spell checking with automatic corrections (WARNING: modifies source files)" OFF
)
mark_as_advanced(PROJECT_ENABLE_SPELL)

if(NOT PROJECT_ENABLE_SPELL)
  return()
endif()
...
Or set PROJECT_ENABLE_SPELL=OFF to disable spell checking"
  )
else()
  ...
  message(
    WARNING
      "PROJECT_ENABLE_SPELL is ON: codespell will modify source files directly to fix spelling errors. "
