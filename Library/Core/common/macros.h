...
//
// PROJECT_HAS_THREE_WAY_COMPARISON evaluates to 1 when both the compiler
...
//
// Usage:
//   #if PROJECT_HAS_THREE_WAY_COMPARISON
...
#define PROJECT_HAS_THREE_WAY_COMPARISON 1
#else
#define PROJECT_HAS_THREE_WAY_COMPARISON 0
#endif
#endif
...
//   Use __cxa_demangle (see PROJECT_HAS_CXA_DEMANGLE below) for a
//   human-readable name.
...
#define PROJECT_HAS_CXA_DEMANGLE 0
#elif (__GNUC__ >= 4 || (__GNUC__ >= 3 && __GNUC_MINOR__ >= 4)) && !defined(__mips__)
#define PROJECT_HAS_CXA_DEMANGLE 1
