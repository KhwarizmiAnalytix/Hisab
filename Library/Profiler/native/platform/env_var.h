...
// returned.
PROFILER_API bool read_bool_from_env_var(
...
PROFILER_API bool read_int64_from_env_var(
...
PROFILER_API bool read_float_from_env_var(
...
// If it is unset, the default value is used.
PROFILER_API bool read_string_from_env_var(
