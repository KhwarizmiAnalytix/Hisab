...
struct PROFILER_VISIBILITY SymbolizedTracebacks
{
...
struct PROFILER_VISIBILITY CapturedTraceback : public profiler::GatheredContext
{
    ...
    struct Python
    {
        ...
        virtual void                 appendSymbolized(
                            const std::vector<PyFrame>& to_symbolize, SymbolizedTracebacks& st) = 0;
...
private:
    ...
    friend PROFILER_API SymbolizedTracebacks
