...
struct PROFILER_VISIBILITY ProfilerConfig
{
    ...
    PROFILER_API bool pushGlobalCallbacks() const;
...
// -- Profiler base class -----------------------------------------------------
// ----------------------------------------------------------------------------
struct PROFILER_VISIBILITY ProfilerStateBase : public MemoryReportingInfoBase
{
    PROFILER_API explicit ProfilerStateBase(ProfilerConfig config);
    ...
    PROFILER_API ~ProfilerStateBase() override;

    PROFILER_API static ProfilerStateBase* get(bool global);
    ...
    PROFILER_API static void push(std::shared_ptr<ProfilerStateBase>&& state);

    PROFILER_API static std::shared_ptr<ProfilerStateBase> pop(bool global);
...
PROFILER_API bool               profilerEnabled();
