...
struct LexerImpl
{
    LexerImpl(void* data, void* base = nullptr, void* end = nullptr)
        : next_((const char*)data), base_((int64_t)base), end_((const char*)end)
    {
    }
    ...
    T read()
    {
        ...
        UNWIND_CHECK(
            !checked || end <= end_, "read out of bounds {} >= {}", (void*)end, (void*)end_);
    ...
    const char* readCString()
    {
        ...
        UNWIND_CHECK(false, "string is out of bounds {} >= {}", (void*)next_, (void*)end_);
    }
