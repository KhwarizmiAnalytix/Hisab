...
PROFILER_API IValueComparator getLessThanComparator(const IValue& v);
PROFILER_API IValueComparator getGreaterThanComparator(const IValue& v);
...
struct PROFILER_VISIBILITY IValue final
{
   ...
   */
    PROFILER_API friend bool operator==(const IValue& lhs, const IValue& rhs);
    PROFILER_API friend bool operator!=(const IValue& lhs, const IValue& rhs);
   ...
   */
    PROFILER_API friend bool _fastEqualsForContainer(const IValue& lhs, const IValue& rhs);
...
#undef DEFINE_CASE
    ...
    // concise/pretty form
    PROFILER_API friend std::ostream& operator<<(std::ostream& out, const IValue& v);
...
struct PROFILER_VISIBILITY WeakIValue final
{
    WeakIValue() = default;
...
struct PROFILER_VISIBILITY WeakOrStrongTypePtr
{
