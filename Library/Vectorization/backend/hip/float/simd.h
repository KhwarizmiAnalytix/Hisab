...
// HIP GPU scalar backend for float.
//
...
struct simd<float>
{
    ...
    VECTORIZATION_SIMD_METHOD simd_t invsqrt(simd_t x) { return 1.0f / ::sqrtf(x); }
    ...
    VECTORIZATION_SIMD_METHOD_NON_INLINE simd_t exp10(simd_t x) { return ::powf(10.0f, x); }
