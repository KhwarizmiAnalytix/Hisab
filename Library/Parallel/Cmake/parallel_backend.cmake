...
# - CMake directly: cmake -DPARALLEL_BACKEND=std (or openmp, tbb)
#
# ARGUMENT FLOW:
...
# 4. QuarismaFlags.create_cmake_flags() generates: -DPARALLEL_BACKEND=tbb
# 5. CMake receives PARALLEL_BACKEND=tbb and this module processes it
# 6. This module enables/disables PARALLEL_ENABLE_TBB and PARALLEL_ENABLE_OPENMP
# 7. compile_definitions.cmake converts these to PARALLEL_HAS_TBB and PARALLEL_HAS_OPENMP
#
# SUPPORTED BACKENDS:
#   - std:     Standard C++ thread backend (std_thread)
#              Result: PARALLEL_HAS_TBB=0, PARALLEL_HAS_OPENMP=0
#   - openmp:  OpenMP backend for parallel processing
#              Result: PARALLEL_HAS_OPENMP=1, PARALLEL_HAS_TBB=0
#   - tbb:     Intel Threading Building Blocks (TBB) backend
#              Result: PARALLEL_HAS_TBB=1, PARALLEL_HAS_OPENMP=0
#
...
set(PARALLEL_BACKEND "std"
    CACHE STRING "SMP backend selection: std, openmp, or tbb")
set_property(CACHE PARALLEL_BACKEND PROPERTY STRINGS std openmp tbb)

# Validate the selected backend
string(TOLOWER "${PARALLEL_BACKEND}" _parallel_backend_lower)
if(NOT _parallel_backend_lower MATCHES "^(std|openmp|tbb)$")
    message(FATAL_ERROR
        "Invalid PARALLEL_BACKEND value: '${PARALLEL_BACKEND}'. "
...
elseif(_parallel_backend_lower STREQUAL "openmp")
    ...
    set(PARALLEL_ENABLE_TBB OFF CACHE BOOL "Enable Intel TBB (Threading Building Blocks) support" FORCE)
...
elseif(_parallel_backend_lower STREQUAL "tbb")
    ...
    # Enable TBB support
    set(PARALLEL_ENABLE_TBB ON CACHE BOOL "Enable Intel TBB (Threading Building Blocks) support" FORCE)
