...
# - PARALLEL_ENABLE_WIN32_THREADS: ON on Windows systems
# - PARALLEL_MAX_THREADS: Maximum number of threads supported (default: 64)
#
# Compile definitions emitted (always 1 or 0, never ON/OFF):
# - PARALLEL_HAS_PTHREADS=1/0
...
if(NOT TARGET Threads::threads)
  ...
  # Export thread configuration as compile definitions (1/0) on the interface target.
  # $<BOOL:...> converts ON/OFF → 1/0 so the preprocessor always sees an integer.
  target_compile_definitions(parallel_threads INTERFACE
    PARALLEL_HAS_PTHREADS=$<BOOL:${PARALLEL_ENABLE_PTHREADS}>
