...
public:
    ...
    void collectAllContainedMemoryLocations(const Element* elem, MemoryLocations& cont) const;
...
private:
    ...
    void collectAllContainedMemoryLocationsImpl(const Element* elem, MemoryLocations& cont) const;
