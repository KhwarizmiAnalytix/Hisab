...
TORCH_API void ONNXShapeTypeInference(Node* n, const ParamMap& params_dict, int opset_version);
...
TORCH_API void ONNXShapeTypeInference(
    std::shared_ptr<Graph>& g, const ParamMap& params_dict, int opset_version);
