...
using quarisma::DeviceGuard;
using quarisma::DimnameList;
using quarisma::IntArrayRef;
using quarisma::OptionalDeviceGuard;
using quarisma::Scalar;
using quarisma::Tensor;
using quarisma::TensorList;
using quarisma::TensorOptions;
    ...
    const Scalar& start, const Scalar& end, const Scalar& step, Tensor result)
{
    ...
    return quarisma::range_out(result, start, end, step);
}

inline static Tensor dispatch_range(
    const Scalar& start, const Scalar& end, const Scalar& step, const TensorOptions& options)
{
...
static PyObject* THPVariable_range(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    static PythonArgParser parser({
        "range(Scalar start, Scalar end, Scalar step=1, *, Tensor out=None, ScalarType dtype=None, "
        "Layout layout=torch.strided, Device device=None, bool requires_grad=False)",
    });
    ...
    if (r.idx == 0)
    {
        ...
        else
        {
            check_out_type_matches(
                r.tensor(3), r.scalartype(4), r.isNone(4), r.layout(5), r.device(6), r.isNone(6));
...
// declarable See: Quarisma/native/README.md for more context
...
static Tensor dispatch_nonzero(const Tensor& self, Tensor out)
{
    pybind11::gil_scoped_release no_gil;
    OptionalDeviceGuard          device_guard(device_of(self));
    return quarisma::nonzero_out(out, self);
}
...
THPVARIABLE_SPARSE_COMPRESSED_CTOR(
    ...
    10,
    ({"sparse_compressed_tensor(PyObject* compressed_indices, PyObject* plain_indices, PyObject* "
      "values, IntArrayRef size, *, ScalarType dtype=None, Layout? layout=None, Device? "
      "device=None, bool pin_memory=False, bool requires_grad=False, bool check_invariants=None)",
      "sparse_compressed_tensor(PyObject* compressed_indices, PyObject* plain_indices, PyObject* "
      "values, *, ScalarType dtype=None, Layout? layout=None, Device? device=None, bool "
      "pin_memory=False, bool requires_grad=False, bool check_invariants=None)"}))
THPVARIABLE_SPARSE_COMPRESSED_CTOR(
    sparse_csr_tensor,
    10,
    ({"sparse_csr_tensor(PyObject* crow_indices, PyObject* col_indices, PyObject* values, "
      "IntArrayRef size, *, ScalarType dtype=None, Layout? layout=None, Device? device=None, bool "
      "pin_memory=False, bool requires_grad=False, bool check_invariants=None)",
      "sparse_csr_tensor(PyObject* crow_indices, PyObject* col_indices, PyObject* values, *, "
      "ScalarType dtype=None, Layout? layout=None, Device? device=None, bool pin_memory=False, "
      "bool requires_grad=False, bool check_invariants=None)"}))
THPVARIABLE_SPARSE_COMPRESSED_CTOR(
    sparse_csc_tensor,
    10,
    ({"sparse_csc_tensor(PyObject* ccol_indices, PyObject* row_indices, PyObject* values, "
      "IntArrayRef size, *, ScalarType dtype=None, Layout? layout=None, Device? device=None, bool "
      "pin_memory=False, bool requires_grad=False, bool check_invariants=None)",
      "sparse_csc_tensor(PyObject* ccol_indices, PyObject* row_indices, PyObject* values, *, "
      "ScalarType dtype=None, Layout? layout=None, Device? device=None, bool pin_memory=False, "
...
THPVARIABLE_SPARSE_COMPRESSED_CTOR(
    sparse_bsr_tensor,
    10,
    ({"sparse_bsr_tensor(PyObject* crow_indices, PyObject* col_indices, PyObject* values, "
      "IntArrayRef size, *, ScalarType dtype=None, Layout? layout=None, Device? device=None, bool "
      "pin_memory=False, bool requires_grad=False, bool check_invariants=None)",
      "sparse_bsr_tensor(PyObject* crow_indices, PyObject* col_indices, PyObject* values, *, "
      "ScalarType dtype=None, Layout? layout=None, Device? device=None, bool pin_memory=False, "
...
THPVARIABLE_SPARSE_COMPRESSED_CTOR(
    sparse_bsc_tensor,
    10,
    ({"sparse_bsc_tensor(PyObject* ccol_indices, PyObject* row_indices, PyObject* values, "
      "IntArrayRef size, *, ScalarType dtype=None, Layout? layout=None, Device? device=None, bool "
      "pin_memory=False, bool requires_grad=False, bool check_invariants=None)",
      "sparse_bsc_tensor(PyObject* ccol_indices, PyObject* row_indices, PyObject* values, *, "
      "ScalarType dtype=None, Layout? layout=None, Device? device=None, bool pin_memory=False, "
...
static PyObject* THPVariable_sparse_coo_tensor(PyObject* self, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
    static PythonArgParser parser({
        "sparse_coo_tensor(PyObject* indices, PyObject* values, *, ScalarType dtype=None, Device? "
        "device=None, bool pin_memory=False, bool requires_grad=False, bool check_invariants=None, "
        "bool is_coalesced=None)",
        "sparse_coo_tensor(PyObject* indices, PyObject* values, IntArrayRef size, *, ScalarType "
        "dtype=None, Device? device=None, bool pin_memory=False, bool requires_grad=False, bool "
        "check_invariants=None, bool is_coalesced=None)",
        "sparse_coo_tensor(IntArrayRef size, *, ScalarType dtype=None, Device? device=None, bool "
        "requires_grad=False, bool check_invariants=None)",
    });
...
static PyObject* THPVariable_tensor(PyObject* self, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
    static PythonArgParser parser({
        "tensor(PyObject* data, *, ScalarType dtype=None, Device? device=None, bool "
        "pin_memory=False, bool requires_grad=False, DimnameList? names=None)",
    });
...
static PyObject* THPVariable_frombuffer(PyObject* self_, PyObject* args, PyObject* kwargs)
{
    ...
    static PythonArgParser parser(
        {
            "frombuffer(PyObject* buffer, *, ScalarType dtype, int64_t count=-1, int64_t offset=0, "
    ...
    if (r.idx == 0)
    {
        ...
        TORCH_CHECK_VALUE(
            PyObject_CheckBuffer(buffer) != 0, "object does not implement Python buffer protocol.");
        return wrap(torch::utils::tensor_frombuffer(buffer, dtype, count, offset, requires_grad));
    }
...
static PyObject* THPVariable_asarray(PyObject* self_, PyObject* args, PyObject* kwargs)
{
    ...
    static PythonArgParser parser(
        {
            "asarray(PyObject* obj, *, ScalarType? dtype=None, Device? device=None, bool? "
            "copy=None, bool requires_grad=False)",
        },
        /*traceable=*/false);
...
static PyObject* THPVariable_nonzero(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    if (as_tuple)
    {
        QUARISMA_CHECK(!has_out, "nonzero does not support the out kwarg when as_tuple is True");
...
static void gatherTorchFunctions(std::vector<PyMethodDef>& torch_functions)
{
    ...
    torch_functions.assign(torch_functions_manual, torch_functions_manual + num_functions);
    ...
    for (const auto& alias : aliases)
    {
        auto it = std::find_if(
            ...
            torch_functions.end(),
            [&](const PyMethodDef& def) { return strcmp(def.ml_name, alias.first) == 0; });
...
static PyTypeObject THPVariableFunctions = {
    PyVarObject_HEAD_INIT(nullptr, 0) "torch._C._VariableFunctionsClass", /* tp_name */
    0,                                                                    /* tp_basicsize */
    0,                                                                    /* tp_itemsize */
    nullptr,                                                              /* tp_dealloc */
...
void initTorchFunctions(PyObject* module)
{
    ...
    if (PyModule_AddObject(
            module, "_VariableFunctionsClass", reinterpret_cast<PyObject*>(&THPVariableFunctions)) <
        0)
    {
        throw python_error();
    }
    ...
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            return quarisma::functionalization::impl::
    ...
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            auto impl = quarisma::functionalization::impl::unsafeGetFunctionalWrapper(t);
    ...
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            return quarisma::functionalization::impl::are_all_mutations_hidden_from_autograd(t);
        });
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            quarisma::functionalization::impl::mark_mutation_hidden_from_autograd(t);
        });
    py_module.def(
    ...
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            quarisma::functionalization::impl::sync(t);
        });
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            quarisma::functionalization::impl::commit_update(t);
        });
    py_module.def(
        "_functionalize_replace",
        [](const quarisma::Tensor& t, const quarisma::Tensor& o)
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            TORCH_INTERNAL_ASSERT(!quarisma::functionalization::impl::isFunctionalTensor(o));
            quarisma::functionalization::impl::replace_(t, o);
        });
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            return quarisma::functionalization::impl::isBaseTensor(t);
        });
    py_module.def(
        ...
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            auto t_impl = quarisma::functionalization::impl::unsafeGetFunctionalWrapper(t);
    ...
    py_module.def(
        ...
        {
            auto old = quarisma::functionalization::impl::getFunctionalizationReapplyViewsTLS();
            quarisma::functionalization::impl::setFunctionalizationReapplyViewsTLS(reapply_views);
            return old;
        },
    ...
    py_module.def(
        ...
        [](const quarisma::Tensor& t, bool before)
        {
            TORCH_INTERNAL_ASSERT(quarisma::functionalization::impl::isFunctionalTensor(t));
            auto wrapper = quarisma::functionalization::impl::unsafeGetFunctionalWrapper(t);
    ...
    py_module.def(
        ...
        [](quarisma::Tensor& dst, const quarisma::Tensor& src)
        {
            ...
            //   tensors.
            quarisma::native::checkSetStorage(
                dst,
                src.storage(),
    ...
    py_module.def(
        ...
        [](const quarisma::Tensor& t)
        { return quarisma::functionalization::impl::isFunctionalTensor(t); });
    py_module.def(
        "_to_functional_tensor",
        [](const quarisma::Tensor& t)
        { return quarisma::functionalization::impl::to_functional_tensor(t); });
    py_module.def(
        "_from_functional_tensor",
        [](const quarisma::Tensor& t)
        { return quarisma::functionalization::impl::from_functional_tensor(t); });
    py_module.def(
        "_freeze_functional_tensor",
        [](const quarisma::Tensor& t)
        { quarisma::functionalization::impl::freeze_functional_tensor(t); });
    py_module.def(
        "_enable_functionalization",
        [](bool reapply_views = false)
        {
            if (quarisma::impl::tls_is_dispatch_key_included(quarisma::DispatchKey::Functionalize))
            {
                TORCH_INTERNAL_ASSERT(
                    false,
    ...
    py_module.def(
        ...
        [](const quarisma::Tensor& src_, const quarisma::Tensor& dst_)
        {
