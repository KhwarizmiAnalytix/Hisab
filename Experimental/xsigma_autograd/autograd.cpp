...
// NB: This code duplicates existing logic quarisma torch/autograd/__init__.py and
...
static variable_list _make_grads(const variable_list& outputs, const variable_list& grad_outputs)
{
