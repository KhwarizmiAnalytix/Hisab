...
PyObject* THPAutograd_initExtension(PyObject* _unused, PyObject* unused)
{
    ...
    py::class_<torch::autograd::InputMetadata>(m, "_InputMetadata")
        ...
        .def_property_readonly("shape", &torch::autograd::InputMetadata::shape_as_dim_vector)
        .def_property_readonly(
            "is_nested_tensor", &torch::autograd::InputMetadata::is_nested_tensor)
        .def_property_readonly(
            "is_cpp_nested_tensor", &torch::autograd::InputMetadata::is_cpp_nested_tensor);

    py::class_<KinetoEvent>(m, "_KinetoEvent")
        // name of the event
        .def("name", [](const KinetoEvent& e) { return e.name(); })
        .def("overload_name", [](const KinetoEvent& e) { return e.overload_name(); })
        ...
        .def("is_hidden_event", [](const KinetoEvent& e) { return e.isHiddenEvent(); })
    ...
    py::class_<ProfilerDisableOptions>(m, "_ProfilerDisableOptions").def(py::init<bool, bool>());
    m.def(
...
static PyObject* is_autocast_enabled(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
    static PythonArgParser parser(
...
static PyObject* get_autocast_dtype(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
...
static PyObject* set_autocast_dtype(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
    static PythonArgParser parser(
...
static PyObject* is_autocast_available(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
...
static PyObject* set_autocast_gpu_dtype(PyObject* _unused, PyObject* arg)
{
    HANDLE_TH_ERRORS
    TORCH_CHECK_TYPE(
        THPDtype_Check(arg), "dtype must be a torch.dtype (got ", Py_TYPE(arg)->tp_name, ")");
    TORCH_WARN_DEPRECATION(
...
static PyObject* any_requires_grad(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
...
static PyObject* any_output_is_alias_to_input_or_output(PyObject* _unused, PyObject* args)
{
    HANDLE_TH_ERRORS
...
static PyObject* set_view_replay_enabled(PyObject* self, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
    static PythonArgParser parser({
...
static PyObject* get_function_stack_at(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
...
static PyObject* get_dispatch_stack_at(PyObject* _unused, PyObject* args, PyObject* kwargs)
{
    HANDLE_TH_ERRORS
    static PythonArgParser parser({"get_stack_at(int64_t level)"});
...
static PyObject* THPModule_increment_version(PyObject* _unused, PyObject* tensor_list)
{
    HANDLE_TH_ERRORS
...
static PyMethodDef methods[] = {
    ...
    {"is_anomaly_check_nan_enabled", is_anomaly_check_nan_enabled, METH_NOARGS, nullptr},
    ...
    {"_exit_dual_level",
     ...
     METH_VARARGS | METH_KEYWORDS,
     nullptr},
    {"_is_torch_function_mode_enabled", is_torch_function_mode_enabled, METH_NOARGS, nullptr},
