...
// ============================================================================
struct QUARISMA_API RawTensorMetadataBase
{
...
struct QUARISMA_API RawTensorMetadata : RawTensorMetadataBase
{
...
struct QUARISMA_API TensorMetadata : public RawTensorMetadataBase
{
    TensorMetadata(
...
// Used during post processing.
struct QUARISMA_API ProfilerStepInfo
{
...
class QUARISMA_VISIBILITY FallbackPair
{
...
#if 0
class QUARISMA_VISIBILITY PyFrameState
{
    int                line_no_;
...
class QUARISMA_VISIBILITY NNModuleInfo
{
...
class QUARISMA_VISIBILITY OptimizerInfo
{
    struct ParameterInfo
    {
        TensorMetadata                                      metadata_;
...
class QUARISMA_VISIBILITY PyExtraFieldsBase
{
...
struct QUARISMA_API Result : public std::enable_shared_from_this<Result>
{
...
class QUARISMA_VISIBILITY KinetoObserverContext : public quarisma::ObserverContext
{
    struct Event
    {
...
public:
    ...
    bool isSupportedScalarList(const quarisma::IValue& list_candidate);
...
class QUARISMA_API RecordQueue
{
public:
...
QUARISMA_API void set_record_concrete_inputs_enabled_fn(std::function<bool()> /*fn*/);
QUARISMA_API void set_record_concrete_inputs_enabled_val(bool /*val*/);

QUARISMA_API bool get_fwd_bwd_enabled();
QUARISMA_API void set_fwd_bwd_enabled_fn(std::function<bool()> /*fn*/);
QUARISMA_API void set_fwd_bwd_enabled_val(bool /*val*/);

QUARISMA_API bool get_cuda_sync_enabled();
QUARISMA_API void set_cuda_sync_enabled_fn(std::function<bool()> /*fn*/);
QUARISMA_API void set_cuda_sync_enabled_val(bool /*val*/);

// Comms related RecordFunctions will record information about tensor storage
// locations.
QUARISMA_API bool get_record_tensor_addrs_enabled();
