...
struct Section
{
    ...
    CheckedLexer lexer(size_t offset) { return CheckedLexer(data + offset, data, data + size); }
};
...
#undef ELF_CHECK
        ...
        UNWIND_CHECK(ehdr_->e_shstrndx < ehdr_->e_shnum, "invalid strtab section offset");
